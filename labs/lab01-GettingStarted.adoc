...
[source,shell]
----
git clone https://github.com/{YOUR-REPO}/vertx-insult-gateway.git
----
  ...
  public void testThatTheServerIsStarted(TestContext tc) {  //          <3>
    ...
    vertx.createHttpClient().getNow(8080, "localhost", "/", response -> {  //          <4>
      ...
      response.bodyHandler(body -> {
        ...
        tc.assertTrue(body.toString().equalsIgnoreCase("Hello Vert.x!"));  //          <6>
        async.complete();
      });
    });
  }
...
<4>  We instantiate the WebClient to test our endpoint
...
Rinse and repeat.  Your test should pass.  If it doesn't raise your hand and ask one of the guys proctoring the lab for help.
